...
const highscore = students.filter((s) => s.score >= 80).map((s) => s.name);
console.log("80 or more:", highscore);
...
// TODO
const ranking = students.slice().sort((a, b) => b.score - a.score);
ranking.forEach((s, i) => console.log(`${i + 1}. ${s.name} (${s.dept}) ${s.score}`));